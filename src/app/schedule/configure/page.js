        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Configure Schedule</h1>
                <p className="text-gray-600">Set up your working hours and appointment settings</p>
              </div>
            </div>
          </div>
        </header>
                  ...
                  {daysOfWeek.map((day) => (
                    <label
                      ...
                      className={`flex flex-col items-center p-4 rounded-lg border-2 cursor-pointer transition-colors ${
                        formData.working_days.includes(day.key)
